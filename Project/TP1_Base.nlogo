...
turtles-own[energia]
limpadores-own[qtdResiduos] ;Memoria
globals [nAlimento nLNormal nLToxico nDepositos]
...
to Go
  if count comiloes = 0 or count limpadores = 0 or ticks = 10000
  [
    stop
  ]
  morte-agentes
      ...
      [   ;verifica-se se a celula é verde
        ...
        [  ;Caso contrario verifica-se se alguma das suas percecoes forem azuis
          ...
          [
            ...
            ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
            ;;;;;;;;;;;;;;;;;;;;;;;;;;;Pendente de percecao de comida ou nao;;;;;;;;;;;
            ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
"" ""
PENS
"limpadores" 1.0 0 -13345367 true "" "plot count limpadores"
...
@#$#@#$#@
<experiments>
  <experiment name="Analise1" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="Analise2" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count comiloes</metric>
    <metric>count limpadores</metric>
  ...
  <experiment name="Analise3" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count comiloes</metric>
    <metric>count limpadores</metric>
  ...
  <experiment name="Analise4" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count comiloes</metric>
    <metric>count limpadores</metric>
  ...
  <experiment name="Analise5" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count comiloes</metric>
    <metric>count limpadores</metric>
